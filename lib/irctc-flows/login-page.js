...
class LoginPage {
  ...
  async enterCredentials(username, password) {
    try {
      ...
      // After entering password, automatically click CAPTCHA field to focus it
      ...
      try {
        ...
        if (await captchaField.isExisting()) {
          ...
          console.log('[LoginPage] CAPTCHA field clicked and focused');
        }
      } catch (e) {
        console.log('[LoginPage] Could not click CAPTCHA field:', e.message);
      }
