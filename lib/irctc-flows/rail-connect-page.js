...
class RailConnectPage {
  ...
  async clickTrainButton() {
    try {
      const trainButtonSelector = '//android.widget.LinearLayout[@resource-id="cris.org.in.prs.ima:id/my_journey_ll"]/android.widget.ImageView';
      ...
      while (attempts < maxAttempts) {
        try {
          const trainButton = await this.driver.$(trainButtonSelector);
